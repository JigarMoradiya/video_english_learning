...
export const OU_OW_AUDIO_FRAMES = track.totalFrames;      // the narration's own length
export const OU_OW_16X9_DURATION = track.totalFrames + OUTRO_PAD;
...
const overlayFor = (b: Beat) => {
  switch (b.id) {
    ...
    case "wrap": return <StoreOutro silent total={b.durationInFrames + OUTRO_PAD} bg="rgba(255,252,248,0.76)" />;
    default: return null;
  }
};
