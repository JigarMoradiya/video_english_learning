    ...
    <>
      {ROWS.map((count, row) => {
        ...
        return Array.from({ length: count }, (_, col) => {
          ...
          const bg = current ? GOLD_TILE : done && isVowel ? GOLD_TILE : isVowel ? "rgba(255,159,67,0.18)" : "rgba(56,86,190,0.1)";
          ...
          return (
            <div
              ...
              style={{
                ...
                boxShadow: current ? "0 8px 22px rgba(255,140,0,0.5), 0 0 0 5px rgba(255,159,67,0.3)" : "none",
