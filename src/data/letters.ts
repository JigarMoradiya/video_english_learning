...
export const LETTERS: LetterItem[] = [
  ...
  { letter: "E", word: "Elephant", soundToken: "Eh", audio: "e_elephant_sound", image: "elephant", durSec: 8.829, accent: "#8E24AA", imageColor: "#6D6D6D", extras: ["Egg", "Envelope", "Eagle", "Ear", "Eye", "Elbow"], timings: [0.35, 0.90, 1.60, 2.10, 2.55, 3.60, 4.30, 4.65] },
  { letter: "F", word: "Fish", soundToken: "Fff", audio: "f_fish_sound", image: "fish", durSec: 8.281, accent: "#0097A7", imageColor: "#F8A640", extras: ["Frog", "Fan", "Fox", "Flower", "Fig", "Flamingo"], timings: [0.20, 0.70, 1.45, 1.85, 2.25, 3.50, 4.10, 4.60] },
  ...
  { letter: "N", word: "Nest", soundToken: "Nuh", audio: "n_nest_sound", image: "nest", durSec: 7.236, accent: "#0277BD", imageColor: "#8A765C", extras: ["Nose", "Net", "Neck", "Nurse", "Nail", "Notebook"], timings: [0.20, 0.75, 1.60, 2.15, 2.7, 3.65, 4.25, 4.50] },
  ...
  { letter: "U", word: "Umbrella", soundToken: "Uh", audio: "u_umbrella_sound", image: "umbrella", durSec: 8.516, accent: "#7B1FA2", imageColor: "#DE8C3C", extras: ["Unicorn", "Ufo", "Uniform", "Utensil", "Umpire", "Unicycle"], timings: [0.25, 0.85, 1.70, 2.15, 2.60, 3.75, 4.65, 4.90] },
  { letter: "V", word: "Van", soundToken: "Vuh", audio: "v_van_sound", image: "van", durSec: 8.046, accent: "#1565C0", imageColor: "#58A3C0", extras: ["Violin", "Vase", "Volcano", "Vulture", "Vest", "Volleyball"], timings: [0.20, 0.75, 1.45, 1.95, 2.35, 3.40, 4.10, 4.35] },
  ...
  { letter: "Y", word: "Yoga", soundToken: "Yuh", audio: "y_yoga_sound", image: "yoga", durSec: 8.359, accent: "#7CB342", imageColor: "#FDC29F", extras: ["Yak", "Yarn", "Yacht", "Yo-yo", "Yogurt", "Yolk"], timings: [0.20, 0.80, 1.5, 1.95, 2.4, 3.70, 4.50, 4.75] },
  { letter: "Z", word: "Zebra", soundToken: "Zuh", audio: "z_zebra_sound", image: "zebra", durSec: 8.594, accent: "#512DA0", imageColor: "#292521", extras: ["Zip", "Zoo", "Zero", "Zucchini", "Zigzag", "Zinnia"], timings: [0.20, 0.80, 1.65, 2.10, 2.55, 3.70, 4.50, 4.75] },
];
