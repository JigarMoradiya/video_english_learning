  ...
  return (
    <>
      {REC_LETTERS.map((l, i) => {
        ...
        // The CURRENT tile is the video's own PURPLE (the header's "Phonics" colour) — it
        // used to be the same orange as a done vowel, so "which one is speaking" and
        // "which vowels are done" were indistinguishable.
        ...
        const bg = current ? "#8E24AA" : done ? (isVowel ? "#FF9F43" : GRAY) : isVowel ? "rgba(255,159,67,0.18)" : GRAY;
        ...
        return (
          <div
            ...
            style={{
              ...
              borderRadius: 16,
              background: bg,
              boxShadow: current ? "0 10px 26px rgba(142,36,170,0.5), 0 0 0 6px rgba(142,36,170,0.26)" : done ? "0 4px 12px rgba(30,36,56,0.08)" : "none",
              display: "flex",
              alignItems: "center",
